...
char *test_new() {
  ...
  mu_assert(val1 != NULL, "Failed to make a new array element");

  val2 = DArray_new(array);
  mu_assert(val2 != NULL, "Failed to make a new array element");
