...
Stats *Stats_create() { return Stats_recreate(0.0, 0.0, 0L, 0.0, 0.0); }

double Stats_mean(Stats *st) { return st->sum / st->n; }
...
void Stats_dump(Stats *st) {
  printf("sum: %f, sumsq: %f, n: %ld, min: %f, max: %f, mean: %f, stddev: %f\n",
